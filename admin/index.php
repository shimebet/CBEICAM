...
<?php if (isset($_SESSION['user'])) : ?>   
<!-- <strong><a href="../ej/index.php" style=" text-align: center; color:black;">Download/View</a></strong>
&nbsp;&nbsp;&nbsp; -->

<!-- <div class="dropdown" style="color:red">
<button type="button" class="btn  dropdown-toggle" data-toggle="dropdown" style=" text-align: center; color:black;">
...
<strong><h6 style="text-align: center; color:black; font-style:italic;">WELCOME TO CBE ATM DATA </h6>  </strong>
<div class="row">
<?php
// include('index1.php');
?>
