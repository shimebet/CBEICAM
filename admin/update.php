...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
<!-- <strong><a href="create_user.php" style=" text-align: center; color:black;">AddUser</a></strong>
&nbsp;&nbsp;&nbsp; -->
...
<h6 style="text-align: center; color:black; font-style:italic;">User Update Information </h6>
<div class="row">
<?php
// Define variables and initialize with empty values
$username = $email = $user_type = $district = "";
$name_err = $address_err = $usertype_err = $district_err="";
...
// Validate user type
$input_usertype = trim($_POST["user_type"]);
if(empty($input_usertype)){
$usertype_err = "Please enter the usern type.";     
} 
else{
$user_type = $input_usertype;
}
// Validate district
...
if(empty($name_err) && empty($address_err) && empty($usertype_err) && empty($district_err)){
// Prepare an update statement
$sql = "UPDATE users SET username=?, email=?, user_type=?, district=? WHERE id=?";

if($stmt = mysqli_prepare($db, $sql)){
// Bind variables to the prepared statement as parameters
mysqli_stmt_bind_param($stmt, "ssssi", $param_name, $param_address, $param_usertype, $param_district, $param_id);
...
<input type="text" name="email" class="form-control <?php echo (!empty($address_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $email; ?>">
<span class="invalid-feedback"><?php echo $address_err;?></span>
</div>
<div class="form-group">
<label>User Type</label>
<input type="text" name="user_type" class="form-control <?php echo (!empty($usertype_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $user_type; ?>">
<span class="invalid-feedback"><?php echo $usertype_err;?></span>
</div>

<div class="form-group">
<label>District</label>
<input type="text" name="district" class="form-control <?php echo (!empty($districte_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $district; ?>">
<span class="invalid-feedback"><?php echo $district_err;?></span>
</div>
<input type="hidden" name="id" value="<?php echo $id; ?>"/>
<input type="submit" class="btn btn-primary" value="Submit">
<a href="adminoperation.php" class="btn btn-secondary ml-2">Cancel</a>
</form>
