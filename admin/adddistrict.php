...
<h6 style="text-align: center; color:black; font-style:italic;">Register New District Or Terminal </h6>
...
<div class="input-group">
<label>ATM/Branch Name</label>
<input type="text" name="atmname">
</div>
<div class="input-group">
...
<select name="atm_type" id="user_type">
<option value=""></option>
<option value="NCR">NCR</option> 
<option value="DIBOLD">DIBOLD</option>
</select>
</div>
<div class="input-group">
...
<div class="input-group">
<button type="submit" class="btn" name="register_btn1"> Submit</button>
</div>
</form>
</div>
</div>
