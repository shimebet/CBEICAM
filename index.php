...
<nav class="navbar navbar-inverse" style="background-color:rgb(187, 52, 153);">
  <div class="container-fluid">
    <div class="navbar-header">
     ...
     <strong> <a class="navbar-brand" href="index.php" style="color: white;">CBE ATM DATA</a></strong>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar" >
      <ul class="nav navbar-nav">
        ...
        <li><a href="contact.php" style="color: white; font-size:larger;">Contact Us</a></li>
      </ul>
...
<img src="images/side2.png" alt="ussd" style="width:10%; height: 40px;"> 
</div>
