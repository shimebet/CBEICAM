...
<strong style="color:green">  Online: &nbsp;&nbsp;<?php echo $_SESSION['user']['username']; ?></strong>
        ...
        <div id="content">
         ...
         <div class="row">
         <!-- <div class="column">
         <img src="../images/cbe1.jpg" alt="Snow" style="width:100%">
         </div>
         <div class="column">
         <img src="../images/cbe3.jpg" alt="Forest" style="width:100%">
         </div>
         <div class="column">
         <img src="../images/cbe7.jpg" alt="Mountains" style="width:100%">
         </div>  -->
         </div>
        </div>
    </div>
