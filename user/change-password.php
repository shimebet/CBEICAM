...
<h6 style="text-align: center; color:black; font-style:italic;">Change Password </h6>
<div class="row">
<link rel="stylesheet" type="text/css" href="passwordstyle.css">
<div class="loginsec">
<form action="change-p.php" method="post" class="form1">
...
<button type="submit" style=" background-color: #83bd92;" class="sub1">Submit</button><br>
<a href="index.php"><button type="button" class="btn btn-primary sub1" style="background-color: #c57c7b;">Cancel </button></a>
</form>
</div>
</div>
</div>
